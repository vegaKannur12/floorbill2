...
class SunmiHome extends StatefulWidget {
  const SunmiHome({Key? key}) : super(key: key);

  @override
  _SunmiHomeState createState() => _SunmiHomeState();
}

class _SunmiHomeState extends State<SunmiHome> {
                  ...
                  children: [
                    GestureDetector(
                      onTap: () async {
                        ...
                        Uint8List byte =
                            await _getImageFromAsset('assets/print.png');
